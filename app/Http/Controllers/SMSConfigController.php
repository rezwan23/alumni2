...
class SMSConfigController extends Controller
{
    ...
    {
        return view('admin.sms.new', ['config'=>SmsConfig::all()->first()]);
    }
    ...
    {
        return view('admin.sms.group.new', ['groups'=>SmsGroup::all(),'config'=>SmsConfig::all()->first()]);
    }
    ...
    {
        return view('admin.sms.index', ['smss'=>SmsHistory::all()]);
    }

    public function createGroup()
    {
        return view('admin.sms.group.create');
    }
